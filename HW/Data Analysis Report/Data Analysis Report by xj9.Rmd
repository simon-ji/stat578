...
```{r}
s_1 = summary(coef_sample_1[,c("beta_0","beta_female","beta_year")])
s_1
```
...
beta_female_mean = mean(beta_female_sample)
beta_female_mean
```
...
### (f)
```{r}
dic_1 = dic.samples(model_1, 100000)
dic_1
```
...
```{r}
x2 <- coda.samples(model_2, c("beta_0","beta_female","beta_year", "sigma_person"), n.iter = 10000)
...
```{r}
summary_2 = summary(coef_sample_2[, c("beta_0","beta_female","beta_year", "sigma_person")])
summary_2
```

### (d)
```{r}
dic_2 = dic.samples(model_2, 100000)
dic_2
```
...
saveRDS(x1, file ="x1.rds")
saveRDS(coef_sample_1, file ="coef_sample_1.rds")
saveRDS(dic_1, file ="dic_1.rds")

saveRDS(model_2, file ="model_2.rds")
saveRDS(x2, file ="x2.rds")
saveRDS(coef_sample_2, file ="coef_sample_2.rds")
saveRDS(dic_2, file ="dic_2.rds")
```
